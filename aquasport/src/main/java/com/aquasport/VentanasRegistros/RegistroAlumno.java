...
public class RegistroAlumno extends RegistrosBase {
    ...
    private void configurarModoEdicion(Alumno a) {
        modoEdicion = true;
        idAlumnoEditar = a.getIdAlumno();
        registroBoton.setText("Guardar Cambios");
        
        nombreField.setText(a.getNombreCompleto());
        alergiasField.setText(a.getAlergias());
        telefonoField.setText(a.getTelefono());
        telefonoEmergenciaField.setText(a.getTelefonoEmergencia());
        direccionField.setText(a.getDireccion());
        nacimientoChooser.setDate(a.getFechaNacimiento());
    }
    ...
    private void confirmarSalida() {
        ...
        if (nombre.isEmpty() && nacimientoChooser.getDate() == null) {
            dispose();
            return;
        }
